<template>
    ...
    <div class="row mt-5">
        <div class="col-lg-8">
            ...
            <p class="mt-5 sub-title lh-lg text-secondary">
                Hello There! <br />
                I'm Nabiel Mada, currently working as freelancer, you can check <br />
                my portofolio. Excited to create projects and to help others, i'm currently <br />
                learning design and code (Web Developer). I'm natively speak Indonesian <br />
                and is learning english.
            </p>

            <p class=" sub-title text-secondary lh-lg">
        ...
        <div class="col-lg-4">
            ...
            <div class="row mt-4 pt-2 mx-1">
                <div class="col-lg-2 mx-2 text-end">
